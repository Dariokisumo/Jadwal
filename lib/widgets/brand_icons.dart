...
/// Authentic brand vector icons for AI assistants, sourced from official brand SVGs.
class GeminiBrandIcon extends StatelessWidget {
  final double size;
  final Color? color;

  const GeminiBrandIcon({
    super.key,
    this.size = 20,
    this.color,
  });
...
''';
  ...
  Widget build(BuildContext context) {
    // Official Google Gemini brand blue
    final effectiveColor = color ?? const Color(0xFF1A73E8);
    return SizedBox(
      width: size,
      height: size,
...
class ChatGptBrandIcon extends StatelessWidget {
  final double size;
  final Color? color;

  const ChatGptBrandIcon({
    super.key,
    this.size = 20,
    this.color,
  });
...
''';
  ...
  @override
  Widget build(BuildContext context) {
    // Official OpenAI brand teal-green
    final effectiveColor = color ?? const Color(0xFF10A37F);
    return SizedBox(
      width: size,
      height: size,
      child: SvgPicture.string(
...
class ClaudeBrandIcon extends StatelessWidget {
  final double size;
  final Color? color;

  const ClaudeBrandIcon({
    super.key,
    this.size = 20,
    this.color,
  });
...
''';
  ...
  @override
  Widget build(BuildContext context) {
    // Official Anthropic Claude brand warm terracotta tone
    final effectiveColor = color ?? const Color(0xFFD97757);
    return SizedBox(
      width: size,
      height: size,
      child: SvgPicture.string(
